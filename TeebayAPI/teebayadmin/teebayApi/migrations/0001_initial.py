    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('unsold', 'Unsold'), ('sold', 'Sold'), ('rented', 'Rented')], default='unsold', max_length=20)),
                ('dateposted', models.DateField(auto_now_add=True)),
                ('category', models.ManyToManyField(to='teebayApi.Category')),
